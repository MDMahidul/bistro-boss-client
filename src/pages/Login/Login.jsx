      ...
      >
        <div className="py-14 flex items-center justify-center">
          <div className="hero w-11/12 mx-auto  px-8 shadow-2xl">
            <div className="hero-content flex-col-reverse md:flex-row lg:space-x-16 py-14">
                ...
                <form onSubmit={handleLogin} className="card-body">
                  ...
                  <div className="form-control">
                    ...
                    <input
                      ...
                      className="input input-bordered bg-white"
                    />
                    <button className='btn btn-outline border-yellow-600 btn-xs text-yellow-600 mt-3' onClick={handleCaptchValidation}>Check Captcha</button>
                  </div>
